...
- Supported channel and dashboard capabilities that are already defined in canonical schema, tool, state, and error artifacts.
...
- Tenant key/public access behavior for widget interfaces as defined canonically.
