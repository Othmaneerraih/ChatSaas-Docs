...
- Auth and access expectations in canonical schema/error/rls artifacts (`docs/canonical/schema.md`, `docs/canonical/errors.md`, `docs/canonical/rls.md`).
...
- Canonical dashboard auth interfaces (paths are not enumerated in canonical sources):
...
- Webhook interfaces do not use JWT.
...
- Widget configuration read access policy is not fully enumerated in canonical sources and is tracked in Open Questions.
