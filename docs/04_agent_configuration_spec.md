...
- Redefining interface contracts beyond canonical artifacts.
...
- TODO: Canonical artifacts define `config_version` but do not define config history retention/window policy; confirm retention requirements and audit linkage expectations.
