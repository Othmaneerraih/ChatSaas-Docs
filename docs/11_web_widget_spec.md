...
1. Widget initializes in tenant context and loads configuration through the canonical widget configuration interface (path not explicitly enumerated in canonical sources).
